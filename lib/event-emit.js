 ...
 * @param {Number} start Optional index for geojson.geometry.coordinates at
 * which to start the Emitter events
 */
function Emitter(geojson, updateInterval) {
   ...
   *
   * @param {Number} optional stepsTaken value for seeking purposes.
  ...
  this.next = function(optional) {
    var i;
    optional ? i = optional : i = stepsTaken * updateInterval; // if the time interval is provided, use that; otherwise, use stepsTaken * updateInterval
